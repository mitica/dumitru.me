  ...
  return (
    <section className="space-y-10">
      <div>
        ...
        <h1 className="title-display mt-2 text-4xl font-semibold text-emerald-950">Proiecte</h1>
        <p className="section-copy mt-2">Lista proiectelor active și a celor închise.</p>
      </div>

      <div className="space-y-4">
        <h2 className="title-display text-2xl font-semibold text-emerald-950">
          Proiecte active <sup className="text-emerald-900/45">{active.length}</sup>
        </h2>
      ...
      <div className="space-y-4">
        <h2 className="title-display text-2xl font-semibold text-emerald-950">
          Proiecte inactive <sup className="text-emerald-900/45">{inactive.length}</sup>
        </h2>
